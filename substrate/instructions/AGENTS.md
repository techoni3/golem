...
| `golem:skill-authoring` | Writing or editing a skill, `SKILL.md`, agent persona, or this instructions file. Covers instruction scope, structure, front matter, plain technical language, and the editorial check. |
