...
const DEFAULTS = {
  ...
  events: {
    // GOL-424: subscriptions retain durable history and manual passive interest,
    // but must not independently start a model turn by default.
    subscriptionDigestEnabled: false,
  },
  harnesses: {
