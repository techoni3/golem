...
const contracts = [
  ...
  {
    name: 'session_spawn',
    description: 'Spawn one detached Pi worker through the shared worker manager. Returns the live worker name, session id, role, model, and attach hint. Unknown roles and readiness timeouts return structured, actionable errors; a failed spawn remains inspectable with the CLI.',
    inputSchema: object({
