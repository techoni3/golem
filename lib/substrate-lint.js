...
// Role cards carry identity and a skill pointer only. The compact routing table lives in
...
export function lintSubstrate({ substrateRoot, home = golemHome() } = {}) {
  ...
  // The Roles table is the compact registry for role responsibility and skill routing. If it goes
  // missing, or a registered role has no row, the cards no longer have a shared routing source.
