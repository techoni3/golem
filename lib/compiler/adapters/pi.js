...
export function buildPlan({ repoRoot, substrateRoot: suppliedSubstrateRoot, packageVersion }) {
  ...
  const capabilities = {
    ...
    limitation: 'First-class worker only: builder, explorer, and reviewer roles; no Pi lead orchestration or native subagents. Extensions run with host-full-trust.',
  };
