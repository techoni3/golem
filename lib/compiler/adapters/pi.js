...
const PI_ROLES = Object.freeze(['builder', 'explorer', 'reviewer', 'lead']);
...
export function buildPlan({ repoRoot, substrateRoot: suppliedSubstrateRoot, packageVersion }) {
  ...
  const capabilities = {
    ...
    limitation: 'Pi runs as a first-class participant: builder, explorer, reviewer, and lead roles; no Pi-native subagents. Extensions run with host-full-trust.',
  };
