...
export function buildPlan({ substrateRoot, repoRoot, packageVersion }) {
    ...
    items.push({
      ...
      build: () => {
        ...
        return name === 'tracker-client.test.mjs'
          ? text.replaceAll("../../dashboard/server/", "../../../dashboard/server/")
          : text;
      },
    });
  }
  ...
  for (const name of [
    'session-role.js', 'role-preset.js', 'golem-home.js', 'project-id.js', 'session-facts.js', 'session-facts-write.js',
    'session-registry.js', 'worker-registry.js', 'tmux-driver.js', 'worker-manager.js', 'golem-tmux.conf',
