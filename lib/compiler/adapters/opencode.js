...
// Role cards render alongside skills under the opencode render dir. opencode has
// no native notion of a role, so nothing discovers these automatically — they are
// resolved by path, by `readRoleCard()` and by the shim's role-brief push.
